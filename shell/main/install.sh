...
# Accepts the following environment:
# $cluster_version: The version of Kubernetes this build of Longshoreman targets. Defaults to latest stable.
...
declare -A asdf_plugins=(
    [kubectl]="${cluster_version:-latest}"
    [krew]="latest"
)
